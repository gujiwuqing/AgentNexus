  ...
  return (
    <div className={`bg-background border-2 ${borderColor} rounded-lg px-3 py-2 min-w-[140px] shadow-sm`}>
      ...
      <div className="flex items-center gap-2 mb-1">
        <span>🔧</span>
        <span className="text-xs font-semibold truncate">{d.label || t("nodeTypes.transform.label")}</span>
      </div>
      <p className="text-[10px] text-muted-foreground truncate">{d.config?.operation || t("nodeDefaults.noOperation")}</p>
